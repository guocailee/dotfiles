var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)nodejs\.org$/.test(host)) return "DIRECT";
        if (/(?:^|\.)icomoon\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)d1azc1qln24ryf\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)wccftech\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dsh7ky7308k4b\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)marcysutton\.github\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)memect\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)adadvisor\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)cssdeck\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mythings\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d3966zi6nldrug\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)dpclk\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)rubiconproject\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)facebook\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)alocdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)egrappler\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gravatar\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)crwdcntrl\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)quantserve\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jd\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yacamera\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)quora\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)5d6d\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)davidwalsh\.name$/.test(host)) return "+proxy";
        if (/(?:^|\.)d2zah9y47r7bi2\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)buysellads\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)admedo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)staticworld\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)pcworld\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)viglink\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yldbt\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)imrworldwide\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)perfectmarket\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)gigya\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)adzerk\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)scorecardresearch\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sstatic\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)whatwg\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)vimeo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)googleblog\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dwn0odqttrkhc\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)frontendfront\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)winisp\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)codota\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)css-tricks\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)softwareag\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)agentzh\.blogspot\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)agentzh\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ajax\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oxygenna\.com$/.test(host)) return "DIRECT";
        ...
        if (/(?:^|\.)d22wsyl1zemnyu\.cloudfront\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)stackshare\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)cokebar\.info$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)igodigital\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)skimresources\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tutsplus\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)crsspxl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)punchtab\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ineedabargain\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mybetamail\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)grails\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)chriscowley\.me\.uk$/.test(host)) return "+proxy";
        if (/(?:^|\.)apache\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)planetcassandra\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)csdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)datastax\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zemanta\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)liquidweb\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)optimizely\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)freshdesignweb\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d348unuw4205d6\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)d1zqrvc06emslq\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)slack\.global\.ssl\.fastly\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)wordnik\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cnodejs\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)simplereach\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d8rk54i4mohrb\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)chartbeat\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)swiftype\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)techcrunch\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gravity\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)agile42\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)agilofortrac\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jetstrap\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)reddit\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)stackoverflow\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)is26\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)readme\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)getbootstrap\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)softpedia-static\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)omgubuntu\.co\.uk$/.test(host)) return "+proxy";
    ...
    "+__ruleListOf_auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)barracuda\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)toshiba\.com$/.test(host)) return "+proxy";
        ...
        if (/^http:\/\/canyu\.org/.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)discogs\.com$/.test(host)) return "+proxy";
        ...
        if (/^http:\/\/e123\.hk\//.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)elephantvpn\.com$/.test(host)) return "+proxy";
        ...
        if (/^falunasia\.info/.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)rnw\.global\.ssl\.fastly\.net$/.test(host)) return "+proxy";
        ...
        if (/^http:\/\/gfw\.press/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/onionhacker\.github\.io/.test(url)) return "+proxy";
        if (/^http:\/\/wsgzao\.github\.io\/post\/gfw-break/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/fang-lizhi\.hxwk\.org\//.test(url)) return "+proxy";
        ...
        if (/^http:\/\/.*timesofindia\.indiatimes\.com.*dalai/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/www\.konachan\.com/.test(url)) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf(".nanzao.com/sc/china/20223") >= 0) return "+proxy";
        if (scheme === "http" && url.indexOf(".nanzao.com/sc/hk-macau-tw") >= 0) return "+proxy";
        ...
        if (/^https:\/\/rnw.*\.global\.ssl\.fastly\.net\//.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)scihub\.org$/.test(host)) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf("blockedonweibo.tumblr.com") >= 0) return "+proxy";
        if (/(?:^|\.)fqrouter\.tumblr\.com$/.test(host)) return "+proxy";
        if (scheme === "http" && url.indexOf("fanqiangkan.tumblr.com") >= 0) return "+proxy";
        if (scheme === "http" && url.indexOf("fubaichina.tumblr.com") >= 0) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf("dns.v2ex.com") >= 0) return "+proxy";
        ...
        if (/^http:\/\/zh\.wikinews\.org/.test(url)) return "+proxy";
        if (/^http:\/\/zh\.wikivoyage\.org/.test(url)) return "+proxy";
        if (/^http:\/\/zh\.wiktionary\.org/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/.*\.google\..*facebook/.test(url)) return "+proxy";
        if (/^http:\/\/.*\.google\..*falun/.test(url)) return "+proxy";
        if (/^http:\/\/.*\.google\..*twitter/.test(url)) return "+proxy";
